...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Embedding Strikingly support')
    ...
    parser.add_argument('-z', '--zendesk', type=str, required=True,
                        help='https://？？？.com/api-reference/help_center/help-center-api/articles/#list-articles')
